...
<head>
  ...
  <link rel="stylesheet" href="<%=request.getContextPath() %>/resources/css/expert_aside.css">
...
<%@ include file="./expert_aside/header.jsp" %>
<%@ include file="./expert_aside/aside.jsp" %>
