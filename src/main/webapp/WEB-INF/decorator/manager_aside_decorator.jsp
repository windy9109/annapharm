...
<head>
  ...
  <link rel="stylesheet" href="<%=request.getContextPath() %>/resources/css/manager_aside.css">
  <!-- summernote -->
  <link rel="stylesheet" href="<%=request.getContextPath() %>/resources/bootstrap/plugins/summernote/summernote-bs4.min.css">

  <%-- <link rel="stylesheet" href="<%=request.getContextPath() %>/resources/css/manager.css"> --%>
...
<%-- <%@ include file="./manager_aside/aside.jsp" %> --%>
