...
<body>
	<div class="content-wrapper" style="background-color: white;">
		...
		<div class="body" style="padding: 30px; padding-top: 3%; font-size: 14px;">
			<div class="card">
				...
				<div class="card-body table-responsive p-0">
					...
					<table class="table text-nowrap table-bordered" id="vertical-1" style="height: 50px; width: 100%; text-align: center;">
						...
						<tr>
							...
							<th style="background: #343a40; color: white; border-top: 1px solid; width: 20%;">조회수</th>
					...
					<!-- 공지내용 -->
					<div class="noticeContent" style="height: 400px; background-color: #f4f6f9; line-height: 30px; padding: 5%;">
						2022년도 약사연수교육 계획을 붙임과 같이 안내드리오니 <br> 본 계획을 숙지하시어 교육 이수에 참고하시기 바랍니다.
					</div>

					<!-- 첨부파일 -->
					<table class="table text-nowrap table-bordered" id="vertical-1" style="height: 50px; width: 100%; text-align: center; height: 80px; line-height: 55px;">
						<tr>
							<th style="background: #343a40; color: white; border-top: 1px solid; width: 20%; height: 80px;">첨부파일</th>
							<td colspan='3' style="background-color: #FFFFFF;">
								<div style="margin-left: 2%;">
									<div class="attachedFile" style="height: 55px; float: left; padding-right: 6px;">
