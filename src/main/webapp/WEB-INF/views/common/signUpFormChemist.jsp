				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-9">
							...
							<div id="validation" style="margin-top: 3px; margin-left: 5px;">
							</div>
						</div>
					</div>
					<div class="row">
					...
					<div class="row">
						<div class="col-3">
						<span tooltip="약사면허번호는 대한약사회 등록 기준" flow="left">
							<i class="fa fa-question-circle-o" style="color: red;"></i>
							<span>약사면허번호</span>
							</span>
<!-- 							<span style=" padding-top: 5px; height: 30px; line-height: 40px;">약사면허번호</span> -->
						...
						<div class="col-6">
							<input type="text" class="form-control form-control-border chemistCode" placeholder="약사면허번호를 입력해주세요" style="margin-top: 5px; width: 100%;">
						</div>
						<div class="col-3">
					...
					<div class="row">
						...
						<div class="col-3" style="padding-top: 5px; height: 30px; line-height: 40px;">
							<span tooltip="이름 또는 주소로 검색해주세요!" flow="left">
								<i class="fa fa-question-circle-o" style="color: red;"></i>
								<span>근무 약국</span>
							</span>
...
<form id="signUpFormChemist">
	...
	<input type="hidden" name="memRegnum" value="" />
	<input type="hidden" name="memEmail" value="" />
	<input type="hidden" name="memTel" value="" />
	<input type="hidden" name="memAddr" value="">
	<input type="hidden" name="memAddr2" value="">
	<input type="hidden" name="memZipcode" value="">
	<input type="hidden" name="chemistCode" value="">
	<input type="hidden" id="formPharmacyCode" name="pharmacyCode" value="">
	<input type="hidden" id="formPharmacyName" name="pharmacyName" value="">
</form>
