...
<body style="background-color: rgba(224, 224, 224, 0.55) !important; font-size: 14px;">
			...
			<div style="margin-left: 20px; margin-right: 20px;">
				...
				<div class="container">
					...
					<div class="row" style="padding: 30px 0px;">
						...
						<div class="col-6">
							<button class="col btn_signup" style="background-color: #2F88FF; color: white;" onclick="signUp('u');">가입하기</button>
						</div>
	...
	<form id="signUpFormUser">
		<input type="hidden" name="memId" value="" /> <input type="hidden" name="memPwd" value="" /> <input type="hidden" name="memName" value="" /> <input type="hidden" name="memRegnum" value="" /> <input type="hidden" name="memEmail" value="" /> <input
			type="hidden" name="memTel" value="" /> <input type="hidden" name="memAddr" value=""> <input type="hidden" name="memAddr2" value=""> <input type="hidden" name="memZipcode" value="">
	</form>
