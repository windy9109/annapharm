									...
									<div class="row">
										...
										<div class="col-sm-3 locationBtn">
											...
											<a href=""
												...
												<a href="prescription.jsp" class="button btnFade btnBlueGreen">작성 완료</a>
										</div>
									</div>
								</div>
										...
										<table class="table table-bordered">
											<tbody>
												<tr>
													...
													<td style="width: 50px;"><input type="number" name="favnum" style="width: 35px;" min="1" max="50" placeholder="3"></td>
													<td style="width: 48px;"><input type="number" name="favnum" style="width: 35px;" min="1" max="50" placeholder="1"></td>
													<td style="width: 48px;">급여</td>
													<td style="width: px;"><i class='far fa-minus-square' style='font-size: 20px; color: red; cursor: pointer;'></i></td>
												</tr>
												<tr>
													<td>3</td>
													<td class="statusReady">전문</td>
													...
													<td>외용</td>
													<td class="medicalTxt">건알펠로디핀정5밀리그램</td>
													<td><input type="number" name="favnum" style="width: 35px;" min="1" max="50" placeholder="3"></td>
													<td><input type="number" name="favnum" style="width: 35px;" min="1" max="50" placeholder="3"></td>
													<td>급여</td>
												...
												<tr>
													...
													<td class="medicalTxt">진타주250IU(모록토코그알파)(혈액응고인자VIII,
														유전자재조합)</td>
													<td><input type="number" name="favnum" style="width: 35px;" min="1" max="50" placeholder="4"></td>
													<td><input type="number" name="favnum" style="width: 35px;" min="1" max="50" placeholder="3"></td>
													<td>급여</td>
													<td><i class='far fa-minus-square' style='font-size: 20px; color: red; cursor: pointer;'></i></td>
												</tr>
