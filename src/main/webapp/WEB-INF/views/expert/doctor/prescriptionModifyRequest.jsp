								...
								<div class="card-header">
									<div class="row">
										...
										<div class="col-sm-5">
											...
											<a href="prescription.jsp" class="button btnFade btnBlueGreen" style="margin-right: 20px;">저장</a> 
									...
									<table class="table table-bordered" style="overflow: auto;">
										...
										<tbody>
											<tr>
												...
												<td><input type="number" name="favnum" style="width: 35px;" min="1" max="50" placeholder="1"></td>
												<td>급여</td>
											</tr>
											<tr>
												<td>3</td>
									...
									<div class="row">
										...
										<div class="col-sm-3 locationBtn">
											...
											<a href=""
												...
												style="margin-right: 20px;">약추가</a> <a href=""
												class="button btnFade btnBlueGreen">작성 완료</a>
										</div>
									</div>
								</div>
