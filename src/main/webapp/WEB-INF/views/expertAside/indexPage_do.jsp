...
<c:if test="${param.mCode == 'D040100'}">
	<script type="text/javascript">
		let f = document.getElementById("main_frame");
		f.src = "/mypage/inquiry/main.do";
	</script>
</c:if>
<c:if test="${param.mCode=='D040200'}">
	<script type="text/javascript">
		let f = document.getElementById("main_frame");
		f.src = "/mypage/userInfo/main.do";
	</script>
</c:if>
<c:if test="${param.mCode == 'D040300'}">
	<script type="text/javascript">
		let f = document.getElementById("main_frame");
		f.src = "/mypage/member/removeForm.do";
	</script>
</c:if>
