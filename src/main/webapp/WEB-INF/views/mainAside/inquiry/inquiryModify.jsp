...
<body>
	<div class="content-wrapper" style="background-color: white">
		...
		<div class="row searchBox">
			...
			<div class="col-lg-8">
				<button type="button" class="btn btn-primary btn_detail">확인</button>
					...
					<div class="card card-secondary card-outline">
						<div class="card-header">
							<div class="row">
								...
								<div class="col-lg-11">
									<input type="text" class="form-control form-control-lg" style="height: 35px;" placeholder="제목을 입력하세요." value="가져온 문의사항 제목">
								</div>							
							</div>
						</div>
						<div class="card-body card-secondary card-outline">
							<div class="row">
								...
								<div class="col-lg-11">
									<textarea class="textarea" name="content" id="content" rows="20" cols="90" placeholder="1000자 내외로 작성하세요." >가져온 문의사항 내용</textarea>
								</div>
							</div>
						</div>
					</div>
