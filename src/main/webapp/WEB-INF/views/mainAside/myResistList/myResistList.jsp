...
<head>
<meta charset="UTF-8">
<title>일반 마이페이지 내 복약질문 내역</title>
<style type="text/css">
.btn_regist {
	border: none;
	border-radius: 5px;
...
<body>
	<div class="content-wrapper">
		<div class="body" style="padding: 30px;">
				<span style="font-weight: bold; font-size: 1.4em; margin-top: 80px;">내 약사IN질문</span>
							...
							<table class="table table-hover text-nowrap"
								...
								<tbody>
									...
									<tr>
										...
										<td>2022.06.30</td>
										<td>2022.07.06</td>
										<td><span class="badge badge-info right" style="background-color: lightgray;">0</span></td>
									</tr>
									<tr>
										<td>내 복약질문 제목</td>
										<td>2022.06.30</td>
