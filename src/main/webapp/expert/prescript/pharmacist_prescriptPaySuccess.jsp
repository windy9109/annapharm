									...
									<div class="card card-primary">
										<div class="card-body" style="text-align: center;">
											...
											<div class="addViewBtn">
												<button onclick="window.open('<%=request.getContextPath() %>/addPatient/addPatient.jsp','환자등록','width=400,height=270,left=600,top=300,location=no,status=no,scrollbars=yes');" 
							...
							<div class="card-header">
								<div class="row">
									...
									<div class="col-sm-5">
										...
										<a href="prescriptionModify.jsp" class="button btnFade btnBlueGreen" style="width: 40px;">수정</a>
									</div>
								</div>
							</div>
							...
							<div class="card-body" style="height: 318px;">
								...
								<div class="row">
									...
									<div class="col-lg-6 col-6 receiptRight">
										...
										<div class="payBtn">
												<button class="paymentBtn" style="background-color: #6e6e6e;">결제</button>
												<button class="successBtn btnBlueGreen" onclick="preSuccess()">조제완료</button>
										</div>
...
<script>
function preSuccess(){
	window.location.href = '<%=request.getContextPath()%>/expert/prescript/pharmacist_prescriptPreSuccess.jsp';
}
</script>
</body>
</html>