						...
						<div class="card card-primary card-outline">
							...
							<div class="card-body " style="height: 57px; padding: 5px;">
								...
								<div class="">
									...
									<input type="text" style="width: 85px;border:1px solid black;" value="" readonly="readonly">
								...
								<div class="row">
									...
									<div class="col-lg-6 col-6 receiptRight">
										...
										<div class="payBtn">
												...
												<button class="successBtn btnBlueGreen" style="background-color: #6e6e6e;">조제완료</button>
										</div>
