	...
	<div style="width: 1200px; margin: 0px auto;">
		...
		<div
			...
			<div style="margin-left: 20px; margin-right: 20px;">
				...
				<span style="width: 150px; display: inline-block; margin-top: 5px;">의사면호번호</span>
				<input type="text" class="form-control form-control-border"
					placeholder="의사면호번호를 입력해주세요"
					style="margin-top: 5px; display: inline-block; width: 270px;">
				...
				<span style="width: 150px; display: inline-block; margin-top: 5px;">근무병원</span>
